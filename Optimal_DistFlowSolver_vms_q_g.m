function [c,P, Q,l,vms,y2,y4,q_g] = Optimal_DistFlowSolver_vms_q_g(nbr,n,PV_n,r,x,p_c,q_c,p_g,q_g,children,injection_matrix,parent,PV_matrix,q_g_max,eps1,eps2,var)
cvx_begin quiet
